    ...
    >
      ...
      <div
        ...
        className={twMerge(
          ...
          side === "left" &&
            "left-0 group-data-[collapsible=hidden]:-left-(--sidebar-width)",
          side === "right" &&
            "right-0 group-data-[collapsible=hidden]:-right-(--sidebar-width)",
          intent === "float" &&
  ...
  if (!collapsed) {
    return (
      <span
        ...
        ref={ref}
        className={twMerge(
          "col-start-2 truncate pe-6 outline-hidden",
          className,
        )}
        {...props}
      />
