...
} from "../agentAccess/AgentAccessControls";
...
export function WorkspaceTools({
  ...
  const elementIds = [...new Set([...selected, ...sourceIds])].filter(
    (id) => !excluded.includes(id),
  );
  return (
    <aside aria-label="Sources and agents" className="h-full overflow-auto">
      <header className="workspace-panel-heading">
        <h2 tabIndex={-1}>Sources & agents</h2>
      ...
      <div className="p-5 space-y-8">
        ...
        <AgentAccessControls
          ...
          selected={elementIds}
          passages={passages}
          onRemoveElement={(id) => setExcluded((ids) => [...ids, id])}
